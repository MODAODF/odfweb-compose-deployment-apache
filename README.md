...
<https://github.com/MODAODF/odfweb-compose-deployment-apache>  
...
1. Download the release package from [the product's Releases page](https://github.com/MODAODF/odfweb-compose-deployment-apache/releases).
...
1. Run the following command to check the specified service logs:
   ...
   Please replace the \_Compose service identifier\_ placeholder to the actual service identifier:
    ...
    + `app`: ODFWEB service + Apache httpd service + PHP runtime.
